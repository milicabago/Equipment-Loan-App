...
const HistoryPage = () => {
    ...
    const deleteHistoryItem = async () => {
        try {
            ...
            await axios.delete(`${process.env.NEXT_PUBLIC_BASE_URL}user/equipmentHistory/${historyToDelete}`, config);
    ...
    return (
        <div className={styles.container}>
            ...
            >
                <h2 className={styles.modalTitle}>Delete equipment history</h2>
                {historyToDelete && (
