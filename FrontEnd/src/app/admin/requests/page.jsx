...
const RequestPage = () => {
    ...
    const acceptRequests = async (requestId) => {
        try {
            ...
            setRequests(prevRequests => prevRequests.map(request => {
                if (request._id === requestId) {
                    return { ...request, return_request_status: 'active' };
                }
                return request;
            }));
            closeAcceptModal();
            ...
            <Modal
                ...
                {requestToRead && (
                    ...
                    <div className={styles.modalContent}>
                        ...
                        <p><span className={styles.label}>Request Updated:</span> <span className={styles.value}>{formatDate(requestToRead.updatedAt)}</span></p>
            ...
            <Modal
                ...
                {requestToAccept && (
                    <div>
                        ...
                        <div className={styles.modalButtons}>
                            <button onClick={() => acceptRequests(requestToAccept._id)}>Confirm</button>
                            <button onClick={closeAcceptModal}>Dismiss</button>
                        </div>
                    </div>
                )}
            </Modal>
            ...
            <Modal
                ...
                {requestToDeny && (
                    <div>
                        ...
                        <div className={styles.modalButtons}>
                            <button onClick={() => denyRequests(requestToDeny._id)}>Confirm</button>
                            <button onClick={closeDenyModal}>Dismiss</button>
                        </div>
                    </div>
                )}
            </Modal>
